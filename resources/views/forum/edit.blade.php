                        ...
                        <div class="bg">
                          <div class="form-group">
                            ...
                            @if (empty($forum->image))
                                <small><i class="fa fa-info-circle"></i> Tidak terdapat gambar / screenshoot pada postingan ini.</small>    
                            @else
                            <div class="form-group">
                               <div class="col-md-4"> 
                               <img src="{{asset('images/'.$forum->image)}}" class="img-thumbnail" alt="" width="100%">
                               </div>
                           </div>
                           @endif 
                          </div>
